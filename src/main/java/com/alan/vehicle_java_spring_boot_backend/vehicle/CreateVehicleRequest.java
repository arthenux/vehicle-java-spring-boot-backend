...
public record CreateVehicleRequest(
        @NotBlank(message = "Vehicle unique ID is required")
        @Size(max = 50, message = "Vehicle unique ID must be 50 characters or fewer")
        @Pattern(regexp = "^[A-Za-z0-9-]+$", message = "Vehicle unique ID may contain letters, numbers, and hyphens only")
        String vehicleId,
